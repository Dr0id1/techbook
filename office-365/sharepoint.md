...
Il est possible de générer un rapport complet pour les permissions d'un site SharePoint à l'aide d'un script PowerShell.

[Vous pouvez le téléchargez ici](https://github.com/Dr0id1/Playbooks/blob/master/Powershell/SharePointReport.ps1)
...
$ReportFile="C:\tmp\SitePermissionRpt.csv"
#endregion
```
...
{% hint style="info" %}
Le script va créer un rapport sommaire des permissions pour les dossiers parents. Si vous souhaitez un rapport détaillé, décommenter la dernière ligne du code contenant le paramètre "Recursive"
{% endhint %}
...
#region ***Parameters***
$SiteURL="https://pcs.sharepoint.com/sites/MONSITE"
$ReportFile="C:\tmp\SitePermissionRpt.csv"
#endregion
...
Generate-PnPSitePermissionRpt -SiteURL $SiteURL -ReportFile $ReportFile -ScanFolders
 ...
 #Call the function to generate permission report recursevily
